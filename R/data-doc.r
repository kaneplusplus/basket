...
#' Medicine 2015; \strong{373}(8):726–736.
#' @references Hobbs BP, Kane MJ, Hong DS, and Landin R.
#' Statistical challenges posed by basket trials: sensitivity analysis 
#' of the Vemurafenib study. \emph{Accepted to the Annals of Clinical 
#' Oncology} 2018.
NULL

#' @title Reference Outputs for Testing
#'
#' @description There are three reference data sets used for testing:
#' eb_reference, eb_reference ub, and fb_reference. These are the the
#' outputs generated by the reference code (in inst/code-from-brian) and
#' are used to detect changes in the output of our implementation.
#' @name eb_reference 
#' @aliases eb_reference_ub fb_reference
#' @docType data
