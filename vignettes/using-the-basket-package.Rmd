...
```{r, out.width='100%',fig.width= 10, fig.align= "center"}

plot_posterior_exchangeability(exact_res$basketwise)
```

Plot prior, likelihood, and posterior probability.
```{r, out.width='100%',fig.width= 12, fig.align= "center"}
plot_all_exchangeability(exact_res$basketwise, c("PRIOR", "MAP", "PEP"), text_size=2.5)
```
```{r, out.width='100%',fig.width= 10, fig.align= "center", fig.}
plot_all_exchangeability(exact_res$basketwise, c("MAP", "PEP"), text_size=3)
`````
